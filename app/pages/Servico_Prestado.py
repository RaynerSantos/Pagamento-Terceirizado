...
import gspread
from utils import client, credentials, PROJETOS, PERIODO_1, PERIODO_2, PERIODO_3
...
with st.form(key="servico"):
    ...
    PERIODO = st.selectbox(label="Informe o período no qual o projeto ocorreu", options=[PERIODO_1, PERIODO_2, PERIODO_3])
